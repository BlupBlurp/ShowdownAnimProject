...
Update: actually I dont know if the scaling is needed, I was scaling them wrong because I was using the front sprites as size reference for back. I will have to test first with scaling 1.0 and correct sizes, and then see if they need to be bigger, so use:

python rename_sprites.py --ani-dir ./References/ani-back
